...
def integrate(func, a, b, c, d, n):
    ...
    trapezoid_results = trapezoid(func, a, b, c, d, n)
...
for n in numbers:
    numbers, results = integrate(function, lower_limit, upper_limit, lower_limity, upper_limity, int(n))
